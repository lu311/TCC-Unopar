...
public final class usuarioConsulta_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>consulta de usuário</title>\n");
      ...
      out.write("                                                <input id=\"fusuario\" name=\"textoconsulta\" type=\"text\" placeholder=\"Digite o nome ou e-mail do usuário\" class=\"form-control\">\n");
      out.write("                                            </div>\n");
      out.write("\n");
      ...
      out.write("                                            <td><h4><span class=\"label label-default\">Nome do usuário </span></h4></td>\n");
      out.write("                                            <td><h4><span class=\"label label-default\">E-mail de acesso</span></h4></td>\n");
      ...
      out.write("                                        <tr>\n");
      out.write("                                            <td>");
      out.print( p.getPk_usuario());
      out.write("</td>\n");
      out.write("                                            <td>");
      out.print( p.getNome_usuario());
      out.write("</td>\n");
      out.write("                                            <td>");
 ...
 if (p.isMs_ativo()) {
      ...
      out.write("                    location.href = \"controleUsuario.jsp?action=ativo&pkusuario=\" + id.toString();\n");
      out.write("                }\n");
      out.write("\n");
      out.write("                function usuarioAlterar(codigo) {\n");
      out.write("                    var id = codigo;\n");
      out.write("                    location.href = \"usuarioCadastro.jsp?pkusuario=\" + id.toString();\n");
      out.write("                }\n");
      out.write("                \n");
      out.write("                \n");
      out.write("                function usuarioDeleta(codigo) {\n");
      out.write("                    var id = codigo;\n");
      out.write("                    location.href = \"controleUsuario.jsp?action=deleta&pkusuario=\" + id.toString();\n");
      out.write("                }\n");
      out.write("\n");
      out.write("            </script>                                        \n");
      out.write("\n");
